 ...
 * 音乐模块预置了 Suno Token 和 Suno Base URL 两项配置；编程和视频模块暂为空列表，预留未来扩展。
 *
 * @property music 音乐模块配置（Suno Token, Suno URL）
...
data class ModuleConfigs(
    val music: List<ApiConfig> = listOf(
        ...
        ApiConfig(label = "Suno API Base URL", baseUrl = "https://vector.addzero.site"),
    ),
